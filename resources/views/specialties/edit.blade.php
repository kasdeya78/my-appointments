	...
	<div class="card-body">
		...
		@method('PUT')
			...
			<div class="form-group">
	            ...
	            <input id="name" name="name" class="form-control" type="text" value="{{ old('name', $specialty->name) }}" required>
	        </div>
	        <div class="form-group">
	            <label class="form-control-label" for="name">Descripción</label>
	            <input id="description" name="description" class="form-control" type="text" value="{{ old('description', $specialty->description) }}">
	        </div>
